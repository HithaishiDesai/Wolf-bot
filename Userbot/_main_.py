...
sed = logging.getLogger("Wolf Bot")
...
if Config.ENABLE_ASSISTANTBOT == "ENABLE":
    ...
    sed.info("Wolf  Bot Have Been Installed Successfully !")
else:
    sed.info("Wolf Bot Has Been Installed Sucessfully !")
